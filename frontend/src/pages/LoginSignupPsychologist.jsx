      ...
      <div className="panels-container">
        <div className="panel left-panel">
          <div className="content">
            <h3>Join Our Team</h3>
            <p>Become a part of our professional network and help make a difference in mental health care.</p>
            <button
          ...
          <img src="/images/psych-login.svg" className="image" alt="Psychologist welcome" />
        </div>
        <div className="panel right-panel">
          <div className="content">
            <h3>Welcome Back, Doctor</h3>
            <p>Access your dashboard and continue providing exceptional care to your patients.</p>
            <button
              className="btn transparent"
              id="sign-in-btn"
          ...
          <img src="/images/psych-signup.svg" className="image" alt="Psychologist signup" />
        </div>
      </div>
    </div>
  );
