      ...
      try {
        ...
        if (response.success) {
          ...
          if (response.token && response.user) {
            ...
            // Navigate to dashboard instead of switching to login
            navigate('/dashboard');
          } else {
            // Fallback: Reset form and switch to login if no token
            onSignUpReset();
            setIsSignUpMode(false);
          }
        } else {
      ...
      <div className="panels-container">
        <div className="panel left-panel">
          <div className="content">
            <h3>New to We Matter?</h3>
            <p>Join our supportive community and start your journey to better mental wellness today.</p>
            <button
          ...
          <img src="/images/login.svg" className="image" alt="Welcome illustration" />
        </div>
        <div className="panel right-panel">
          <div className="content">
            <h3>Welcome Back!</h3>
            <p>Continue your wellness journey with us. We're here to support you every step of the way.</p>
            <button
              className="btn transparent"
              id="sign-in-btn"
          ...
          <img src="/images/register.svg" className="image" alt="Sign up illustration" />
        </div>
      </div>
    </div>
  );
