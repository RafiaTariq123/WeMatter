...
export const testimonials = [
  {
    name: "Wardah",
    text: "Having a We Matter therapist is like somebody coming in and kind of shining a light down the path. It just makes it a little bit easier.",
    img: "/images/p1.jpg",
  },
  {
    name: "Nabiha",
  ...
  {
    name: "Amna",
    text: "I like that my We Matter therapist is always checking up on me through text.",
    img: "/images/p4.jpg",
  },
  {
    name: "Merub",
    text: "We Matter has given me a chance to not give up on myself. It’s helped me see things very differently.",
    img: "/images/p5.jpg",
  },
  {
    name: "Areesha",
    text: "We Matter has changed my life because it's given me the confidence to do difficult things.",
    img: "/images/p6.jpg",
  },
];

export const whyWeMatterData = {
  HomePage: {
    title: "Why",
    highlight: "WeMatter?",
    data: [
