      ...
      <Container sx={{ pt: 8, pb: 4 }}>
        ...
        >
          ...
          <Box>
            ...
            >
              Benefits of <b>WeMatter</b>
            </Typography>

            <div className="space-y-6 max-w-md">
              {benefits.map((benefit) => (
                <Card key={benefit.title} className="reason-card border shadow-sm rounded-lg">
                  <CardContent>
                    <Typography
                      variant="h6"
                      color="primary.main"
          ...
          <Box sx={{ bgcolor: "secondary.main", p: 4, borderRadius: 2 }}>
            ...
            >
              As a WeMatter therapist you can earn an estimated
            </Typography>
...
export default BenefitsWeMatter;
